...
TABLES_CREATE_COMMANDS = {
    ...
    'players': "CREATE TABLE `players` ( `hash`	TEXT NOT NULL UNIQUE, `name` TEXT NOT NULL, `age` INTEGER NOT NULL, `class` TEXT NOT NULL,	`coor` TEXT NOT NULL, PRIMARY KEY(`hash`));"
}
