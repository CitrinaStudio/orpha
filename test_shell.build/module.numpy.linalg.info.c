...
static PyObject *const_str_digest_e6d29878148982bb383c2ffd63386eb7;
...
{
    const_str_digest_89e693285590e79430d162136a6b4413 = UNSTREAM_STRING( &constant_bin[ 1068533 ], 1104, 0 );
    const_str_digest_e6d29878148982bb383c2ffd63386eb7 = UNSTREAM_STRING( &constant_bin[ 1069637 ], 20, 0 );
    const_str_digest_02415e64e2eb2af89d58930190432cd8 = UNSTREAM_STRING( &constant_bin[ 1069657 ], 17, 0 );
...
static PyCodeObject *codeobj_b0f8127c7d6f57a5da02203cb2d22c9b;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_e6d29878148982bb383c2ffd63386eb7 );
    codeobj_b0f8127c7d6f57a5da02203cb2d22c9b = MAKE_CODEOBJ( module_filename_obj, const_str_plain_info, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_b0f8127c7d6f57a5da02203cb2d22c9b;
    ...
    // Frame without reuse.
    frame_b0f8127c7d6f57a5da02203cb2d22c9b = MAKE_MODULE_FRAME( codeobj_b0f8127c7d6f57a5da02203cb2d22c9b, module_numpy$linalg$info );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_b0f8127c7d6f57a5da02203cb2d22c9b );
    assert( Py_REFCNT( frame_b0f8127c7d6f57a5da02203cb2d22c9b ) == 2 );
    ...
    frame_b0f8127c7d6f57a5da02203cb2d22c9b->m_frame.f_lineno = 35;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_b0f8127c7d6f57a5da02203cb2d22c9b );
#endif
    popFrameStack();

    assertFrameObject( frame_b0f8127c7d6f57a5da02203cb2d22c9b );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_b0f8127c7d6f57a5da02203cb2d22c9b, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_b0f8127c7d6f57a5da02203cb2d22c9b->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_b0f8127c7d6f57a5da02203cb2d22c9b, exception_lineno );
    }
