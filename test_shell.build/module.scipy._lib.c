...
static PyObject *const_str_digest_926027e4499d6de2848b79484d44c11d;
...
{
    const_str_digest_926027e4499d6de2848b79484d44c11d = UNSTREAM_STRING( &constant_bin[ 1668196 ], 22, 0 );
    const_str_digest_62a1d126f5f5689a7ed562ab720e3387 = UNSTREAM_STRING( &constant_bin[ 1668218 ], 253, 0 );
...
static PyCodeObject *codeobj_c69dfc99166f9245140f7a09676a31c7;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_926027e4499d6de2848b79484d44c11d );
    codeobj_c69dfc99166f9245140f7a09676a31c7 = MAKE_CODEOBJ( module_filename_obj, const_str_plain__lib, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_c69dfc99166f9245140f7a09676a31c7;
    ...
    // Frame without reuse.
    frame_c69dfc99166f9245140f7a09676a31c7 = MAKE_MODULE_FRAME( codeobj_c69dfc99166f9245140f7a09676a31c7, module_scipy$_lib );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_c69dfc99166f9245140f7a09676a31c7 );
    assert( Py_REFCNT( frame_c69dfc99166f9245140f7a09676a31c7 ) == 2 );
    ...
    frame_c69dfc99166f9245140f7a09676a31c7->m_frame.f_lineno = 1;
    {
    ...
    frame_c69dfc99166f9245140f7a09676a31c7->m_frame.f_lineno = 12;
    ...
    frame_c69dfc99166f9245140f7a09676a31c7->m_frame.f_lineno = 14;
    ...
    tmp_called_name_2 = GET_STRING_DICT_VALUE( moduledict_scipy$_lib, (Nuitka_StringObject *)const_str_plain_Tester );
    ...
    frame_c69dfc99166f9245140f7a09676a31c7->m_frame.f_lineno = 15;
    ...
    tmp_assign_source_11 = LOOKUP_ATTRIBUTE( tmp_source_name_2, const_str_plain_test );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_c69dfc99166f9245140f7a09676a31c7 );
#endif
    popFrameStack();

    assertFrameObject( frame_c69dfc99166f9245140f7a09676a31c7 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_c69dfc99166f9245140f7a09676a31c7, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_c69dfc99166f9245140f7a09676a31c7->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_c69dfc99166f9245140f7a09676a31c7, exception_lineno );
    }
