...
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] =
{
    ...
    { (char *)"numpy.distutils", NULL, 1600201, 581, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.__config__", NULL, 1600782, 1063, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.__version__", NULL, 1601845, 332, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.ccompiler", NULL, 1602177, 20086, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command", NULL, 1622263, 1094, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.command.autodist", NULL, 1623357, 2215, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.bdist_rpm", NULL, 1625572, 899, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build", NULL, 1626471, 1896, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_clib", NULL, 1628367, 6924, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_ext", NULL, 1635291, 11010, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_py", NULL, 1646301, 1415, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_scripts", NULL, 1647716, 1726, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.build_src", NULL, 1649442, 18548, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.config", NULL, 1667990, 12233, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.config_compiler", NULL, 1680223, 4228, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.develop", NULL, 1684451, 922, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.egg_info", NULL, 1685373, 1152, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install", NULL, 1686525, 2121, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_clib", NULL, 1688646, 1669, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_data", NULL, 1690315, 966, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.install_headers", NULL, 1691281, 1020, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.command.sdist", NULL, 1692301, 1010, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.compat", NULL, 1693311, 467, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.conv_template", NULL, 1693778, 8154, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.core", NULL, 1701932, 4760, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.cpuinfo", NULL, 1706692, 33624, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.environment", NULL, 1740316, 2699, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.exec_command", NULL, 1743015, 7934, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.extension", NULL, 1750949, 2093, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.fcompiler", NULL, 1753042, 27268, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.distutils.from_template", NULL, 1780310, 6973, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.info", NULL, 1787283, 323, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.lib2def", NULL, 1787606, 3293, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.log", NULL, 1790899, 2457, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.mingw32ccompiler", NULL, 1793356, 14372, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.misc_util", NULL, 1807728, 66845, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.npy_pkg_config", NULL, 1874573, 12494, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.numpy_distribution", NULL, 1887067, 837, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.system_info", NULL, 1887904, 67428, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.distutils.unixccompiler", NULL, 1955332, 3368, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.dual", MOD_INIT_NAME( numpy$dual ), 0, 0, NUITKA_COMPILED_MODULE },
    { (char *)"numpy.f2py", NULL, 1958700, 2054, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.f2py.__version__", NULL, 1960754, 403, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.auxfuncs", NULL, 1961157, 22302, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.capi_maps", NULL, 1983459, 17989, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.cb_rules", NULL, 2001448, 14788, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.cfuncs", NULL, 2016236, 35990, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.common_rules", NULL, 2052226, 4706, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.crackfortran", NULL, 2056932, 75976, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.diagnose", NULL, 2132908, 3759, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f2py2e", NULL, 2136667, 19287, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f2py_testing", NULL, 2155954, 1468, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.f90mod_rules", NULL, 2157422, 7388, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.func2subr", NULL, 2164810, 6757, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.rules", NULL, 2171567, 34214, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.f2py.use_rules", NULL, 2205781, 3103, NUITKA_BYTECODE_FLAG },
    ...
    { (char *)"numpy.testing", NULL, 2208884, 673, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"numpy.testing.decorators", NULL, 2209557, 8301, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.noseclasses", NULL, 2217858, 8981, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.nosetester", NULL, 2226839, 14524, NUITKA_BYTECODE_FLAG },
    { (char *)"numpy.testing.utils", NULL, 2241363, 63338, NUITKA_BYTECODE_FLAG },
    ...
    { (char *)"pkg_resources", NULL, 2304701, 96228, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"pkg_resources.extern", NULL, 2400929, 2368, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"pkg_resources.py31compat", NULL, 2403297, 640, NUITKA_BYTECODE_FLAG },
    ...
    { (char *)"setuptools", NULL, 2403937, 5617, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.archive_util", NULL, 2409554, 5102, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command", NULL, 2414656, 670, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.command.bdist_egg", NULL, 2415326, 13608, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.bdist_rpm", NULL, 2428934, 1721, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.develop", NULL, 2430655, 6369, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.easy_install", NULL, 2437024, 64232, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.egg_info", NULL, 2501256, 20951, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.install", NULL, 2522207, 3918, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.install_scripts", NULL, 2526125, 2223, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.py36compat", NULL, 2528348, 4568, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.sdist", NULL, 2532916, 6193, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.command.setopt", NULL, 2539109, 4547, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.config", NULL, 2543656, 13650, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.depends", NULL, 2557306, 5225, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.dist", NULL, 2562531, 35450, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.extension", NULL, 2597981, 1919, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.extern", NULL, 2599900, 277, NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG },
    { (char *)"setuptools.glob", NULL, 2600177, 3787, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.monkey", NULL, 2603964, 5125, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.namespaces", NULL, 2609089, 3622, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.package_index", NULL, 2612711, 32419, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py26compat", NULL, 2645130, 1007, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py27compat", NULL, 2646137, 755, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py31compat", NULL, 2646892, 1837, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py33compat", NULL, 2648729, 1172, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.py36compat", NULL, 2649901, 2151, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.sandbox", NULL, 2652052, 15854, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.ssl_support", NULL, 2667906, 6619, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.unicode_utils", NULL, 2674525, 1113, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.version", NULL, 2675638, 272, NUITKA_BYTECODE_FLAG },
    { (char *)"setuptools.windows_support", NULL, 2675910, 955, NUITKA_BYTECODE_FLAG },
