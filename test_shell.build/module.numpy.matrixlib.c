...
static PyObject *const_str_digest_88f4faf59d60c72bce2bfe688f6b2009;
...
{
    const_str_digest_0bef2b0813c4d35b7609f913e06b43ea = UNSTREAM_STRING( &constant_bin[ 1289785 ], 64, 0 );
    const_str_digest_88f4faf59d60c72bce2bfe688f6b2009 = UNSTREAM_STRING( &constant_bin[ 1289849 ], 27, 0 );
...
static PyCodeObject *codeobj_7113127a0640263a9437a114857ff7e4;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_88f4faf59d60c72bce2bfe688f6b2009 );
    codeobj_7113127a0640263a9437a114857ff7e4 = MAKE_CODEOBJ( module_filename_obj, const_str_plain_matrixlib, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_7113127a0640263a9437a114857ff7e4;
    ...
    // Frame without reuse.
    frame_7113127a0640263a9437a114857ff7e4 = MAKE_MODULE_FRAME( codeobj_7113127a0640263a9437a114857ff7e4, module_numpy$matrixlib );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_7113127a0640263a9437a114857ff7e4 );
    assert( Py_REFCNT( frame_7113127a0640263a9437a114857ff7e4 ) == 2 );
    ...
    frame_7113127a0640263a9437a114857ff7e4->m_frame.f_lineno = 1;
    {
    ...
    frame_7113127a0640263a9437a114857ff7e4->m_frame.f_lineno = 4;
    ...
    frame_7113127a0640263a9437a114857ff7e4->m_frame.f_lineno = 6;
    ...
    tmp_source_name_2 = GET_STRING_DICT_VALUE( moduledict_numpy$matrixlib, (Nuitka_StringObject *)const_str_plain_defmatrix );

    if (unlikely( tmp_source_name_2 == NULL ))
    {
        tmp_source_name_2 = GET_STRING_DICT_VALUE( dict_builtin, (Nuitka_StringObject *)const_str_plain_defmatrix );
    }
    ...
    tmp_assign_source_10 = LOOKUP_ATTRIBUTE( tmp_source_name_2, const_str_plain___all__ );
    ...
    frame_7113127a0640263a9437a114857ff7e4->m_frame.f_lineno = 10;
    ...
    frame_7113127a0640263a9437a114857ff7e4->m_frame.f_lineno = 11;
    ...
    tmp_assign_source_12 = LOOKUP_ATTRIBUTE( tmp_source_name_3, const_str_plain_test );
    ...
    tmp_called_name_3 = GET_STRING_DICT_VALUE( moduledict_numpy$matrixlib, (Nuitka_StringObject *)const_str_plain__numpy_tester );
    ...
    frame_7113127a0640263a9437a114857ff7e4->m_frame.f_lineno = 12;
    ...
    tmp_assign_source_13 = LOOKUP_ATTRIBUTE( tmp_source_name_4, const_str_plain_bench );
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_7113127a0640263a9437a114857ff7e4 );
#endif
    popFrameStack();

    assertFrameObject( frame_7113127a0640263a9437a114857ff7e4 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_7113127a0640263a9437a114857ff7e4, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_7113127a0640263a9437a114857ff7e4->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_7113127a0640263a9437a114857ff7e4, exception_lineno );
    }
