...
static PyObject *const_str_digest_c92e4f849112a614dacb635d5a2aa954;
static PyObject *const_list_str_digest_ec494fdd186e6f072ef2e4d138e36baf_list;
...
static PyObject *const_str_digest_ec494fdd186e6f072ef2e4d138e36baf;
...
{
    const_str_digest_c92e4f849112a614dacb635d5a2aa954 = UNSTREAM_STRING( &constant_bin[ 1072279 ], 53, 0 );
    const_list_str_digest_ec494fdd186e6f072ef2e4d138e36baf_list = PyList_New( 1 );
    const_str_digest_ec494fdd186e6f072ef2e4d138e36baf = UNSTREAM_STRING( &constant_bin[ 1072279 ], 41, 0 );
    PyList_SET_ITEM( const_list_str_digest_ec494fdd186e6f072ef2e4d138e36baf_list, 0, const_str_digest_ec494fdd186e6f072ef2e4d138e36baf ); Py_INCREF( const_str_digest_ec494fdd186e6f072ef2e4d138e36baf );
    const_str_digest_7ba92c3cf9ad59c087ef50ae2da205b9 = UNSTREAM_STRING( &constant_bin[ 1072332 ], 1141, 0 );
...
static PyCodeObject *codeobj_91643e2ac21007c8a5a8203d5ecfa43f;

static void createModuleCodeObjects(void)
{
    module_filename_obj = const_str_digest_c92e4f849112a614dacb635d5a2aa954;
    codeobj_91643e2ac21007c8a5a8203d5ecfa43f = MAKE_CODEOBJ( module_filename_obj, const_str_plain_ma, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_91643e2ac21007c8a5a8203d5ecfa43f;
    ...
    tmp_assign_source_2 = const_str_digest_c92e4f849112a614dacb635d5a2aa954;
    UPDATE_STRING_DICT0( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain___file__, tmp_assign_source_2 );
    tmp_assign_source_3 = LIST_COPY( const_list_str_digest_ec494fdd186e6f072ef2e4d138e36baf_list );
    ...
    tmp_assign_source_5 = const_str_digest_e2b728902bc5ac4ffc49ba9390615520;
    UPDATE_STRING_DICT0( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain___package__, tmp_assign_source_5 );
    // Frame without reuse.
    frame_91643e2ac21007c8a5a8203d5ecfa43f = MAKE_MODULE_FRAME( codeobj_91643e2ac21007c8a5a8203d5ecfa43f, module_numpy$ma );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_91643e2ac21007c8a5a8203d5ecfa43f );
    assert( Py_REFCNT( frame_91643e2ac21007c8a5a8203d5ecfa43f ) == 2 );

    // Framed code:
    tmp_name_name_1 = const_str_plain___future__;
    tmp_globals_name_1 = ((PyModuleObject *)module_numpy$ma)->md_dict;
    tmp_locals_name_1 = Py_None;
    tmp_fromlist_name_1 = const_tuple_b3c114ff65e5229953139969fd8f9f4c_tuple;
    tmp_level_name_1 = const_int_0;
    frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame.f_lineno = 42;
    ...
    UPDATE_STRING_DICT0( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain_division, tmp_assign_source_7 );
    tmp_assign_source_8 = PyObject_GetAttrString(PyImport_ImportModule("__future__"), "absolute_import");
    assert( tmp_assign_source_8 != NULL );
    UPDATE_STRING_DICT0( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain_absolute_import, tmp_assign_source_8 );
    tmp_assign_source_9 = PyObject_GetAttrString(PyImport_ImportModule("__future__"), "print_function");
    assert( tmp_assign_source_9 != NULL );
    UPDATE_STRING_DICT0( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain_print_function, tmp_assign_source_9 );
    CHECK_OBJECT( (PyObject *)tmp_import_from_1__module );
    Py_DECREF( tmp_import_from_1__module );
    tmp_import_from_1__module = NULL;

    tmp_name_name_2 = const_str_empty;
    tmp_globals_name_2 = ((PyModuleObject *)module_numpy$ma)->md_dict;
    tmp_locals_name_2 = Py_None;
    tmp_fromlist_name_2 = const_tuple_str_plain_core_tuple;
    tmp_level_name_2 = const_int_pos_1;
    frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame.f_lineno = 44;
    ...
    tmp_assign_source_10 = IMPORT_NAME( tmp_import_name_from_1, const_str_plain_core );
    ...
    UPDATE_STRING_DICT1( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain_core, tmp_assign_source_10 );
    tmp_name_name_3 = const_str_plain_core;
    tmp_globals_name_3 = ((PyModuleObject *)module_numpy$ma)->md_dict;
    tmp_locals_name_3 = ((PyModuleObject *)module_numpy$ma)->md_dict;
    tmp_fromlist_name_3 = const_tuple_str_chr_42_tuple;
    tmp_level_name_3 = const_int_pos_1;
    frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame.f_lineno = 45;
    ...
    tmp_globals_name_4 = ((PyModuleObject *)module_numpy$ma)->md_dict;
    tmp_locals_name_4 = Py_None;
    tmp_fromlist_name_4 = const_tuple_str_plain_extras_tuple;
    tmp_level_name_4 = const_int_pos_1;
    frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame.f_lineno = 47;
    ...
    tmp_assign_source_11 = IMPORT_NAME( tmp_import_name_from_2, const_str_plain_extras );
    ...
    UPDATE_STRING_DICT1( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain_extras, tmp_assign_source_11 );
    tmp_name_name_5 = const_str_plain_extras;
    tmp_globals_name_5 = ((PyModuleObject *)module_numpy$ma)->md_dict;
    tmp_locals_name_5 = ((PyModuleObject *)module_numpy$ma)->md_dict;
    tmp_fromlist_name_5 = const_tuple_str_chr_42_tuple;
    tmp_level_name_5 = const_int_pos_1;
    frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame.f_lineno = 48;
    ...
    tmp_assign_source_12 = LIST_COPY( const_list_str_plain_core_str_plain_extras_list );
    ...
    tmp_name_name_6 = const_str_digest_8b84b11583a2cc637a5db7437a6d9711;
    tmp_globals_name_6 = ((PyModuleObject *)module_numpy$ma)->md_dict;
    tmp_locals_name_6 = Py_None;
    tmp_fromlist_name_6 = const_tuple_str_plain__numpy_tester_tuple;
    tmp_level_name_6 = const_int_0;
    frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame.f_lineno = 54;
    ...
    tmp_assign_source_15 = IMPORT_NAME( tmp_import_name_from_3, const_str_plain__numpy_tester );
    ...
    UPDATE_STRING_DICT1( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain__numpy_tester, tmp_assign_source_15 );
    ...
    frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame.f_lineno = 55;
    ...
    tmp_assign_source_16 = LOOKUP_ATTRIBUTE( tmp_source_name_3, const_str_plain_test );
    ...
    UPDATE_STRING_DICT1( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain_test, tmp_assign_source_16 );
    ...
    frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame.f_lineno = 56;
    ...
    tmp_assign_source_17 = LOOKUP_ATTRIBUTE( tmp_source_name_4, const_str_plain_bench );
    ...
    UPDATE_STRING_DICT1( moduledict_numpy$ma, (Nuitka_StringObject *)const_str_plain_bench, tmp_assign_source_17 );

    // Restore frame exception if necessary.
#if 0
    RESTORE_FRAME_EXCEPTION( frame_91643e2ac21007c8a5a8203d5ecfa43f );
#endif
    popFrameStack();

    assertFrameObject( frame_91643e2ac21007c8a5a8203d5ecfa43f );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_91643e2ac21007c8a5a8203d5ecfa43f, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_91643e2ac21007c8a5a8203d5ecfa43f->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_91643e2ac21007c8a5a8203d5ecfa43f, exception_lineno );
    }
