...
static PyObject *const_str_digest_94466893df431d1d1d139287a34ad237;
...
{
    const_str_digest_abd674f6b2d1eb0a46683d38501da8b9 = UNSTREAM_STRING( &constant_bin[ 69490 ], 13, 0 );
    const_str_digest_94466893df431d1d1d139287a34ad237 = UNSTREAM_STRING( &constant_bin[ 69503 ], 18, 0 );
...
static PyCodeObject *codeobj_fe8c20b521491cf33fbda95a09d5611e;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_94466893df431d1d1d139287a34ad237 );
    codeobj_fe8c20b521491cf33fbda95a09d5611e = MAKE_CODEOBJ( module_filename_obj, const_str_plain_inside, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_fe8c20b521491cf33fbda95a09d5611e;
    ...
    // Frame without reuse.
    frame_fe8c20b521491cf33fbda95a09d5611e = MAKE_MODULE_FRAME( codeobj_fe8c20b521491cf33fbda95a09d5611e, module_inside );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_fe8c20b521491cf33fbda95a09d5611e );
    assert( Py_REFCNT( frame_fe8c20b521491cf33fbda95a09d5611e ) == 2 );
    ...
    frame_fe8c20b521491cf33fbda95a09d5611e->m_frame.f_lineno = 1;
    {
    ...
    frame_fe8c20b521491cf33fbda95a09d5611e->m_frame.f_lineno = 3;
    ...
    frame_fe8c20b521491cf33fbda95a09d5611e->m_frame.f_lineno = 4;
    ...
    frame_fe8c20b521491cf33fbda95a09d5611e->m_frame.f_lineno = 5;
    ...
    frame_fe8c20b521491cf33fbda95a09d5611e->m_frame.f_lineno = 6;
    ...
    frame_fe8c20b521491cf33fbda95a09d5611e->m_frame.f_lineno = 7;
    ...
    frame_fe8c20b521491cf33fbda95a09d5611e->m_frame.f_lineno = 8;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_fe8c20b521491cf33fbda95a09d5611e );
#endif
    popFrameStack();

    assertFrameObject( frame_fe8c20b521491cf33fbda95a09d5611e );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_fe8c20b521491cf33fbda95a09d5611e, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_fe8c20b521491cf33fbda95a09d5611e->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_fe8c20b521491cf33fbda95a09d5611e, exception_lineno );
    }
