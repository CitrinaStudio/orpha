...
static void createModuleConstants( void )
{
    ...
    const_str_digest_91f730254e6bceaaf4eb4a6f469a289b = UNSTREAM_STRING( &constant_bin[ 1609733 ], 21, 0 );
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_6dab60cb0853b409585578f334e2fa5f;
    ...
    // Frame without reuse.
    frame_6dab60cb0853b409585578f334e2fa5f = MAKE_MODULE_FRAME( codeobj_6dab60cb0853b409585578f334e2fa5f, module_packaging );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_6dab60cb0853b409585578f334e2fa5f );
    assert( Py_REFCNT( frame_6dab60cb0853b409585578f334e2fa5f ) == 2 );
    ...
    frame_6dab60cb0853b409585578f334e2fa5f->m_frame.f_lineno = 1;
    {
    ...
    frame_6dab60cb0853b409585578f334e2fa5f->m_frame.f_lineno = 4;
    ...
    frame_6dab60cb0853b409585578f334e2fa5f->m_frame.f_lineno = 6;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_6dab60cb0853b409585578f334e2fa5f );
#endif
    popFrameStack();

    assertFrameObject( frame_6dab60cb0853b409585578f334e2fa5f );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_6dab60cb0853b409585578f334e2fa5f, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_6dab60cb0853b409585578f334e2fa5f->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_6dab60cb0853b409585578f334e2fa5f, exception_lineno );
    }
