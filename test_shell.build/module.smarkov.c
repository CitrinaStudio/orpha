...
static PyObject *const_str_digest_ac1b8b5a86b2b41794382891e6e62d28;
...
{
    const_str_digest_ac1b8b5a86b2b41794382891e6e62d28 = UNSTREAM_STRING( &constant_bin[ 1678307 ], 19, 0 );
...
static PyCodeObject *codeobj_d7c3043cf01b4ad1c235112f798eb48d;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_ac1b8b5a86b2b41794382891e6e62d28 );
    codeobj_d7c3043cf01b4ad1c235112f798eb48d = MAKE_CODEOBJ( module_filename_obj, const_str_plain_smarkov, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_d7c3043cf01b4ad1c235112f798eb48d;
    ...
    // Frame without reuse.
    frame_d7c3043cf01b4ad1c235112f798eb48d = MAKE_MODULE_FRAME( codeobj_d7c3043cf01b4ad1c235112f798eb48d, module_smarkov );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_d7c3043cf01b4ad1c235112f798eb48d );
    assert( Py_REFCNT( frame_d7c3043cf01b4ad1c235112f798eb48d ) == 2 );
    ...
    frame_d7c3043cf01b4ad1c235112f798eb48d->m_frame.f_lineno = 1;
    {
    ...
    frame_d7c3043cf01b4ad1c235112f798eb48d->m_frame.f_lineno = 2;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_d7c3043cf01b4ad1c235112f798eb48d );
#endif
    popFrameStack();

    assertFrameObject( frame_d7c3043cf01b4ad1c235112f798eb48d );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_d7c3043cf01b4ad1c235112f798eb48d, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_d7c3043cf01b4ad1c235112f798eb48d->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_d7c3043cf01b4ad1c235112f798eb48d, exception_lineno );
    }
