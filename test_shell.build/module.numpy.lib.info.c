...
{
    const_str_digest_7d8134536515680674da910bddb241f8 = UNSTREAM_STRING( &constant_bin[ 871039 ], 14, 0 );
    const_str_digest_88ae6ea843d3bbe13a8b01b587485e64 = UNSTREAM_STRING( &constant_bin[ 871053 ], 17, 0 );
    ...
    const_str_digest_410b05d2a9a14659b01e6d2ad73b4d66 = UNSTREAM_STRING( &constant_bin[ 871070 ], 6490, 0 );
...
static PyCodeObject *codeobj_c627c2418dcd0a1862b3678cc88478d1;

static void createModuleCodeObjects(void)
{
    module_filename_obj = MAKE_RELATIVE_PATH( const_str_digest_88ae6ea843d3bbe13a8b01b587485e64 );
    codeobj_c627c2418dcd0a1862b3678cc88478d1 = MAKE_CODEOBJ( module_filename_obj, const_str_plain_info, 1, const_tuple_empty, 0, 0, CO_NOFREE );
}
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    struct Nuitka_FrameObject *frame_c627c2418dcd0a1862b3678cc88478d1;
    ...
    // Frame without reuse.
    frame_c627c2418dcd0a1862b3678cc88478d1 = MAKE_MODULE_FRAME( codeobj_c627c2418dcd0a1862b3678cc88478d1, module_numpy$lib$info );

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack( frame_c627c2418dcd0a1862b3678cc88478d1 );
    assert( Py_REFCNT( frame_c627c2418dcd0a1862b3678cc88478d1 ) == 2 );
    ...
    frame_c627c2418dcd0a1862b3678cc88478d1->m_frame.f_lineno = 157;
...
#if 0
    RESTORE_FRAME_EXCEPTION( frame_c627c2418dcd0a1862b3678cc88478d1 );
#endif
    popFrameStack();

    assertFrameObject( frame_c627c2418dcd0a1862b3678cc88478d1 );
    ...
    {
        exception_tb = MAKE_TRACEBACK( frame_c627c2418dcd0a1862b3678cc88478d1, exception_lineno );
    }
    else if ( exception_tb->tb_frame != &frame_c627c2418dcd0a1862b3678cc88478d1->m_frame )
    {
        exception_tb = ADD_TRACEBACK( exception_tb, frame_c627c2418dcd0a1862b3678cc88478d1, exception_lineno );
    }
