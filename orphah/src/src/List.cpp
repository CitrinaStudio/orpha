...
HX_LOCAL_STACK_FRAME(_hx_pos_2a225037e47b8bd7_161_iterator,"List","iterator",0x2d4cdfde,"List.iterator","/usr/share/haxe/std/List.hx",161,0xe39600a5)
...
bool List_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::_List::ListIterator List_obj::iterator(){
            	HX_GC_STACKFRAME(&_hx_pos_2a225037e47b8bd7_161_iterator)
