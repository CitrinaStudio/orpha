...
bool TJSON_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3c672568;
}

::String TJSON_obj::OBJECT_REFERENCE_PREFIX;

 ::Dynamic TJSON_obj::parse(::String json,::String __o_fileName, ::Dynamic stringProcessor){
::String fileName = __o_fileName.Default(HX_HCSTRING("JSON Data","\x42","\x37","\x28","\x24"));
...
static hx::StaticInfo TJSON_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &TJSON_obj::OBJECT_REFERENCE_PREFIX,HX_HCSTRING("OBJECT_REFERENCE_PREFIX","\xa6","\xf7","\x2a","\xe3")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static ::String TJSON_obj_sStaticFields[] = {
	HX_HCSTRING("OBJECT_REFERENCE_PREFIX","\xa6","\xf7","\x2a","\xe3"),
...
{
	hx::Object *dummy = new TJSON_obj;
	TJSON_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("tjson.TJSON","\x2a","\x47","\x65","\x64");
