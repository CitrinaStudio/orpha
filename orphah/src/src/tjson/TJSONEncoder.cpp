...
bool TJSONEncoder_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x31b644dc;
}
...
HXLINE( 368)		if (::Std_obj::is(style,hx::ClassOf< ::tjson::EncodeStyle >())) {
HXLINE( 369)			st = style;
            		}
            		else {
...
HXDLIN( 376)		if (!(::Std_obj::is(obj,hx::ArrayBase::__mClass))) {
HXLINE( 376)			_hx_tmp = ::Std_obj::is(obj,hx::ClassOf< ::List >());
            		}
            		else {
HXLINE( 376)			_hx_tmp = true;
            		}
HXDLIN( 376)		if (_hx_tmp) {
HXLINE( 377)			::String x = this->encodeIterable(obj,st,(int)0);
...
HXLINE( 379)			if (::Std_obj::is(obj,hx::ClassOf< ::haxe::ds::StringMap >())) {
HXLINE( 380)				::String x1 = this->encodeMap(obj,st,(int)0);
...
HXLINE( 383)				{
HXLINE( 383)					::String x2 = this->encodeObject(obj,st,(int)0);
...
HXLINE( 391)		int fieldCount = (int)0;
...
HXDLIN( 402)			if ((_hx_getEnumValueIndex(_g) == (int)6)) {
HXLINE( 403)				hx::Class c = _g->_hx_getObject(0).StaticCast< hx::Class >();
HXDLIN( 403)				{
HXLINE( 404)					fieldCount = (fieldCount + (int)1);
HXDLIN( 404)					if (((fieldCount - (int)1) > (int)0)) {
...
HXLINE( 409)					if (hx::IsNotNull(  ::Dynamic(obj->__Field(HX_("TJ_noEncode",60,bc,0b,f0),hx::paccDynamic)) )) {
...
HXDLIN( 415)				_g1 = (_g1 + (int)1);
HXLINE( 416)				bool _hx_tmp;
HXDLIN( 416)				if (hx::IsNotNull( dontEncodeFields )) {
HXLINE( 416)					_hx_tmp = (dontEncodeFields->indexOf(field,null()) >= (int)0);
            				}
            				else {
...
HXLINE( 420)					fieldCount = (fieldCount + (int)1);
HXDLIN( 420)					if (((fieldCount - (int)1) > (int)0)) {
...
::String TJSONEncoder_obj::encodeMap(::Dynamic obj,::Dynamic style,int depth){
...
HXLINE( 437)		int fieldCount = (int)0;
HXLINE( 438)		{
HXLINE( 438)			 ::Dynamic field = ::haxe::IMap_obj::keys(obj);
...
HXLINE( 439)				fieldCount = (fieldCount + (int)1);
HXDLIN( 439)				if (((fieldCount - (int)1) > (int)0)) {
...
HXLINE( 441)				 ::Dynamic value = ::haxe::IMap_obj::get(obj,field1);
HXLINE( 442)				{
...
HXLINE( 453)		int fieldCount = (int)0;
HXLINE( 454)		{
...
HXLINE( 455)				fieldCount = (fieldCount + (int)1);
HXDLIN( 455)				if (((fieldCount - (int)1) > (int)0)) {
...
HXDLIN( 467)			int _g = this->cache->get_length();
HXDLIN( 467)			while((_g1 < _g)){
HXLINE( 467)				_g1 = (_g1 + (int)1);
HXDLIN( 467)				int c = (_g1 - (int)1);
...
HXDLIN( 477)		if (!(::Std_obj::is(value,hx::ClassOf< int >()))) {
HXDLIN( 477)			_hx_tmp = ::Std_obj::is(value,hx::ClassOf< ::Float >());
            		}
            		else {
...
HXDLIN( 480)			if (!(::Std_obj::is(value,hx::ArrayBase::__mClass))) {
HXLINE( 480)				_hx_tmp1 = ::Std_obj::is(value,hx::ClassOf< ::List >());
            			}
            			else {
...
HXLINE( 482)				return this->encodeIterable(v,style,(depth + (int)1));
            			}
            			else {
HXLINE( 484)				if (::Std_obj::is(value,hx::ClassOf< ::List >())) {
HXLINE( 485)					 ::List v1 = ( ( ::List)(value) );
HXLINE( 486)					return this->encodeIterable(v1,style,(depth + (int)1));
            				}
            				else {
HXLINE( 489)					if (::Std_obj::is(value,hx::ClassOf< ::haxe::ds::StringMap >())) {
HXLINE( 490)						return this->encodeMap(value,style,(depth + (int)1));
            					}
            					else {
HXLINE( 493)						if (::Std_obj::is(value,hx::ClassOf< ::String >())) {
...
HXLINE( 496)							if (::Std_obj::is(value,hx::ClassOf< bool >())) {
...
HXLINE( 502)									return this->encodeObject(value,style,(depth + (int)1));
            								}
            								else {
...
void TJSONEncoder_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("uCache","\x8d","\x41","\x03","\x9c"));
	super::__GetFields(outFields);
};

#if HXCPP_SCRIPTABLE
static hx::StorageInfo TJSONEncoder_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(TJSONEncoder_obj,cache),HX_HCSTRING("cache","\x42","\x9a","\x14","\x41")},
	{hx::fsBool,(int)offsetof(TJSONEncoder_obj,uCache),HX_HCSTRING("uCache","\x8d","\x41","\x03","\x9c")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String TJSONEncoder_obj_sMemberFields[] = {
	...
	HX_HCSTRING("uCache","\x8d","\x41","\x03","\x9c"),
	HX_HCSTRING("doEncode","\x01","\x78","\xfb","\x8d"),
	HX_HCSTRING("encodeObject","\x75","\x99","\x11","\x2d"),
	HX_HCSTRING("encodeMap","\x26","\xc2","\x64","\x1a"),
	HX_HCSTRING("encodeIterable","\xe8","\x52","\x23","\xd8"),
	HX_HCSTRING("cacheEncode","\xf8","\x1d","\x85","\x18"),
	HX_HCSTRING("encodeValue","\x7b","\xad","\x4e","\x3d"),
	::String(null()) };

static void TJSONEncoder_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(TJSONEncoder_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void TJSONEncoder_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(TJSONEncoder_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new TJSONEncoder_obj;
	TJSONEncoder_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("tjson.TJSONEncoder","\x92","\x5b","\x09","\xfd");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = TJSONEncoder_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = TJSONEncoder_obj_sVisitStatics;
#endif
