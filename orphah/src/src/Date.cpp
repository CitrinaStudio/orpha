...
HX_DEFINE_STACK_FRAME(_hx_pos_03b6f5be6798d30f_27_new,"Date","new",0x9aa26240,"Date.new","/usr/share/haxe/std/cpp/_std/Date.hx",27,0xb33fd9ec)
HX_LOCAL_STACK_FRAME(_hx_pos_03b6f5be6798d30f_31_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","/usr/share/haxe/std/cpp/_std/Date.hx",31,0xb33fd9ec)
HX_LOCAL_STACK_FRAME(_hx_pos_03b6f5be6798d30f_51_now,"Date","now",0x9aa26af6,"Date.now","/usr/share/haxe/std/cpp/_std/Date.hx",51,0xb33fd9ec)
HX_LOCAL_STACK_FRAME(_hx_pos_03b6f5be6798d30f_57_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","/usr/share/haxe/std/cpp/_std/Date.hx",57,0xb33fd9ec)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_03b6f5be6798d30f_27_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_03b6f5be6798d30f_31_getTime)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,getTime,return )
 ...
 ::Date Date_obj::now(){
            	HX_STACKFRAME(&_hx_pos_03b6f5be6798d30f_51_now)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(Date_obj,now,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_03b6f5be6798d30f_57_fromTime)
