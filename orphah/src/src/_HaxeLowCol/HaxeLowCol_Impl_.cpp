...
bool HaxeLowCol_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2d8f6023;
}
...
static void HaxeLowCol_Impl__obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(HaxeLowCol_Impl__obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void HaxeLowCol_Impl__obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(HaxeLowCol_Impl__obj::__mClass,"__mClass");
};
...
static ::String HaxeLowCol_Impl__obj_sStaticFields[] = {
	...
	HX_HCSTRING("idGet","\x7b","\x77","\x62","\xb7"),
	HX_HCSTRING("idInsert","\x74","\xe9","\x84","\x86"),
	HX_HCSTRING("idUpdate","\x44","\x2c","\xad","\x6f"),
	HX_HCSTRING("idReplace","\x99","\x15","\x32","\x55"),
	HX_HCSTRING("idRemove","\x7f","\x42","\x30","\xed"),
...
{
	hx::Object *dummy = new HaxeLowCol_Impl__obj;
	HaxeLowCol_Impl__obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("_HaxeLowCol.HaxeLowCol_Impl_","\x0f","\x0a","\xf3","\x87");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &HaxeLowCol_Impl__obj::__GetStatic;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = HaxeLowCol_Impl__obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = HaxeLowCol_Impl__obj_sVisitStatics;
#endif
