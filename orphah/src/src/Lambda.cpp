...
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_44_array,"Lambda","array",0x9c8b0512,"Lambda.array","/usr/share/haxe/std/Lambda.hx",44,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_124_has,"Lambda","has",0x3d8bd693,"Lambda.has","/usr/share/haxe/std/Lambda.hx",124,0x92dd64dc)
HX_LOCAL_STACK_FRAME(_hx_pos_fe797cbef4e9ff25_263_find,"Lambda","find",0x9b838ae0,"Lambda.find","/usr/share/haxe/std/Lambda.hx",263,0x92dd64dc)
...
::cpp::VirtualArray Lambda_obj::array( ::Dynamic it){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_44_array)
...
bool Lambda_obj::has( ::Dynamic it, ::Dynamic elt){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_124_has)
HXLINE( 125)		{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Lambda_obj,has,return )
 ...
 ::Dynamic Lambda_obj::find( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_fe797cbef4e9ff25_263_find)
HXLINE( 264)		{
HXLINE( 264)			 ::Dynamic v = it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 264)			while(( (bool)(v->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 264)				 ::Dynamic v1 = v->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 265)				if (( (bool)(f(v1)) )) {
HXLINE( 265)					return v1;
            				}
            			}
            		}
