...
HXDLIN(  23)		return (from + ::Math_obj::floor((((to - from) + (int)1) * ::Math_obj::random())));
            	}
...
HXLINE(  39)				str = (str + charactersToUse.charAt(::Math_obj::floor((((charactersToUse.length - (int)1) + (int)1) * ::Math_obj::random()))));
            			}
            		}
...
HXDLIN(  53)			_hx_tmp = (arr->get_length() > (int)0);
            		}
            		else {
HXDLIN(  53)			_hx_tmp = false;
            		}
HXDLIN(  53)		if (_hx_tmp) {
HXDLIN(  53)			return arr->__get(::Math_obj::floor((((arr->get_length() - (int)1) + (int)1) * ::Math_obj::random())));
            		}
            		else {
...
HXDLIN(  61)			int _g = arr->get_length();
HXDLIN(  61)			while((_g1 < _g)){
HXLINE(  61)				_g1 = (_g1 + (int)1);
HXDLIN(  61)				int i = (_g1 - (int)1);
HXLINE(  62)				int j = ::Math_obj::floor((((arr->get_length() - (int)1) + (int)1) * ::Math_obj::random()));
...
HXDLIN(  75)				_hx_tmp = (arr->get_length() > (int)0);
            			}
            			else {
HXDLIN(  75)				_hx_tmp = false;
            			}
HXDLIN(  75)			if (_hx_tmp) {
HXDLIN(  75)				return arr->__get(::Math_obj::floor((((arr->get_length() - (int)1) + (int)1) * ::Math_obj::random())));
            			}
            			else {
...
HXDLIN(  81)				_hx_tmp = (arr->get_length() > (int)0);
            			}
            			else {
HXDLIN(  81)				_hx_tmp = false;
            			}
HXDLIN(  81)			if (_hx_tmp) {
HXDLIN(  81)				return arr->__get(::Math_obj::floor((((arr->get_length() - (int)1) + (int)1) * ::Math_obj::random())));
            			}
            			else {
...
static ::String Random_obj_sStaticFields[] = {
	...
	HX_HCSTRING("fromIterable","\x3c","\x7a","\xa3","\x33"),
...
void Random_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("Random","\x23","\x96","\x23","\xec");
