...
HX_LOCAL_STACK_FRAME(_hx_pos_4f13c97c1ff92405_126_keys,"haxe.ds.BalancedTree","keys",0xe94e62a5,"haxe.ds.BalancedTree.keys","/usr/share/haxe/std/haxe/ds/BalancedTree.hx",126,0x65905886)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4f13c97c1ff92405_162_keysLoop,"haxe.ds.BalancedTree","keysLoop",0x20d5eba9,"haxe.ds.BalancedTree.keysLoop","/usr/share/haxe/std/haxe/ds/BalancedTree.hx",162,0x65905886)
...
HX_DEFINE_DYNAMIC_FUNC1(BalancedTree_obj,get,return )
 ...
 ::Dynamic BalancedTree_obj::keys(){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_126_keys)
HXLINE( 127)		::cpp::VirtualArray ret = ::cpp::VirtualArray_obj::__new(0);
...
void BalancedTree_obj::keysLoop( ::haxe::ds::TreeNode node,::cpp::VirtualArray acc){
            	HX_STACKFRAME(&_hx_pos_4f13c97c1ff92405_162_keysLoop)
HXDLIN( 162)		if (hx::IsNotNull( node )) {
