...
void Process_obj::__construct(::String cmd,::Array< ::String > args){
            	HX_GC_STACKFRAME(&_hx_pos_90f6f206b294b77b_96_new)
...
bool block = __o_block.Default(true);
            	HX_STACKFRAME(&_hx_pos_90f6f206b294b77b_107_exitCode)
HXLINE( 108)		if ((block == false)) {
HXLINE( 108)			HX_STACK_DO_THROW(HX_("Non blocking exitCode() not supported on this platform",af,cf,0a,4c));
            		}
HXLINE( 109)		return _hx_std_process_exit(this->p);
            	}
