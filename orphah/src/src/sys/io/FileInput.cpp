...
HX_DEFINE_STACK_FRAME(_hx_pos_b846ebd5a0a404e5_32_new,"sys.io.FileInput","new",0x565591b9,"sys.io.FileInput.new","/usr/share/haxe/std/cpp/_std/sys/io/FileInput.hx",32,0x4095cd33)
HX_LOCAL_STACK_FRAME(_hx_pos_b846ebd5a0a404e5_36_readByte,"sys.io.FileInput","readByte",0x25e0b585,"sys.io.FileInput.readByte","/usr/share/haxe/std/cpp/_std/sys/io/FileInput.hx",36,0x4095cd33)
namespace sys{
namespace io{

void FileInput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_b846ebd5a0a404e5_32_new)
...
int FileInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_b846ebd5a0a404e5_36_readByte)
HXDLIN(  36)		try {
