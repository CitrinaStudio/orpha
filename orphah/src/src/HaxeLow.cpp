...
HXLINE( 121)				HX_STACK_DO_THROW(HX_("HaxeLow: no disk storage set.",69,e8,57,60));
            			}
...
bool HaxeLow_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2d6e300a;
}
...
HXDLIN( 141)				HX_STACK_DO_THROW((_hx_tmp + ::Std_obj::string(e)));
            			}
            			else {
...
HXDLIN(  87)		int a = (int)8;
HXLINE(  88)		{
HXLINE(  88)			::String x = ::StringTools_obj::hex(::Std_obj::_hx_int(::Date_obj::now()->getTime()),(int)8);
...
HXLINE(  89)			a = (a + (int)1);
HXDLIN(  89)			if (!(((a - (int)1) < (int)36))) {
HXLINE(  89)				goto _hx_goto_8;
            			}
HXLINE(  90)			::String x1;
HXDLIN(  90)			if ((((int)(a * (int)51) & (int)(int)52) != (int)0)) {
HXLINE(  91)				int x2;
HXDLIN(  91)				if ((((int)a ^ (int)(int)15) != (int)0)) {
HXLINE(  91)					int x3;
HXDLIN(  91)					if ((((int)a ^ (int)(int)20) != (int)0)) {
HXLINE(  91)						x3 = (int)16;
            					}
            					else {
HXLINE(  91)						x3 = (int)4;
            					}
HXDLIN(  91)					x2 = ((int)(int)8 ^ (int)::Std_obj::_hx_int((::Math_obj::random() * x3)));
            				}
            				else {
HXLINE(  91)					x2 = (int)4;
            				}
HXLINE(  90)				x1 = ::StringTools_obj::hex(x2,null());
            			}
            			else {
HXLINE(  90)				x1 = HX_("-",2d,00,00,00);
            			}
HXDLIN(  90)			if (hx::IsNotNull( uid->charBuf )) {
HXLINE(  90)				uid->flush();
            			}
HXDLIN(  90)			if (hx::IsNull( uid->b )) {
HXLINE(  90)				uid->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            			}
            			else {
HXLINE(  90)				::Array< ::String > uid2 = uid->b;
HXDLIN(  90)				uid2->push(::Std_obj::string(x1));
            			}
            		}
            		_hx_goto_8:;
...
void HaxeLow_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("db","\x7e","\x57","\x00","\x00"));
	outFields->push(HX_HCSTRING("checksum","\xc3","\xbd","\x02","\xad"));
	outFields->push(HX_HCSTRING("disk","\x5d","\x67","\x69","\x42"));
	super::__GetFields(outFields);
};

#if HXCPP_SCRIPTABLE
static hx::StorageInfo HaxeLow_obj_sMemberStorageInfo[] = {
	{hx::fsString,(int)offsetof(HaxeLow_obj,file),HX_HCSTRING("file","\x7c","\xce","\xbb","\x43")},
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(HaxeLow_obj,db),HX_HCSTRING("db","\x7e","\x57","\x00","\x00")},
	{hx::fsString,(int)offsetof(HaxeLow_obj,checksum),HX_HCSTRING("checksum","\xc3","\xbd","\x02","\xad")},
	{hx::fsObject /*::HaxeLowDisk*/ ,(int)offsetof(HaxeLow_obj,disk),HX_HCSTRING("disk","\x5d","\x67","\x69","\x42")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String HaxeLow_obj_sMemberFields[] = {
	...
	HX_HCSTRING("db","\x7e","\x57","\x00","\x00"),
	HX_HCSTRING("checksum","\xc3","\xbd","\x02","\xad"),
	HX_HCSTRING("disk","\x5d","\x67","\x69","\x42"),
	HX_HCSTRING("backup","\x42","\x58","\x99","\x4a"),
	HX_HCSTRING("restore","\x4e","\x67","\xb0","\x6a"),
	HX_HCSTRING("save","\x3d","\x8b","\x4d","\x4c"),
	HX_HCSTRING("col","\x40","\x80","\x4b","\x00"),
	HX_HCSTRING("keyCol","\xe1","\x3b","\xd6","\x3f"),
	HX_HCSTRING("idCol","\x25","\x77","\x5f","\xb7"),
	HX_HCSTRING("_idCol","\x66","\xbe","\x46","\xb3"),
	::String(null()) };

static void HaxeLow_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(HaxeLow_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void HaxeLow_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(HaxeLow_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new HaxeLow_obj;
	HaxeLow_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("HaxeLow","\xee","\x9b","\xb9","\xd5");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &HaxeLow_obj::__GetStatic;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = HaxeLow_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = HaxeLow_obj_sVisitStatics;
#endif
