...
HX_LOCAL_STACK_FRAME(_hx_pos_7ec14b5404d30118_57_getEnv,"Sys","getEnv",0xd9e05658,"Sys.getEnv","/usr/share/haxe/std/cpp/_std/Sys.hx",57,0x4e14a6b5)
...
::String Sys_obj::getEnv(::String s){
            	HX_STACKFRAME(&_hx_pos_7ec14b5404d30118_57_getEnv)
...
int Sys_obj::command(::String cmd,::Array< ::String > args){
            	HX_STACKFRAME(&_hx_pos_7ec14b5404d30118_89_command)
