...
class HXCPP_CLASS_ATTRIBUTES TJSON_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< TJSON_obj > __new() {
			hx::ObjectPtr< TJSON_obj > __this = new TJSON_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< TJSON_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("TJSON","\x7c","\xc4","\xd1","\x8e"); }
