...
class HXCPP_CLASS_ATTRIBUTES TJSONEncoder_obj : public hx::Object
{
	...
	public:
		...
		::String __ToString() const { return HX_HCSTRING("TJSONEncoder","\x80","\x0c","\xff","\x2b"); }
		...
		::String encodeMap(::Dynamic obj,::Dynamic style,int depth);
