...
class HXCPP_CLASS_ATTRIBUTES HaxeLowCol_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< HaxeLowCol_Impl__obj > __new() {
			hx::ObjectPtr< HaxeLowCol_Impl__obj > __this = new HaxeLowCol_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< HaxeLowCol_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("HaxeLowCol_Impl_","\x12","\xc3","\x9b","\xe0"); }
